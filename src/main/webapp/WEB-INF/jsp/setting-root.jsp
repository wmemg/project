...
<body>
    ...
    <div id="sidebar">
            <ul>
                ...
                <li class="current"><a href="#"><img src="img/icons/menu/settings.png" alt="" />系统权限管理</a>
                    <ul>
                        <li class="current"><a href="settingroot.action">权限管理</a></li>
    ...
    <div id="content" class="white">
        ...
        <form action="searchPemission.action">
            <div action="#" class="search-work">
	            <input type="text" name="username" class="text" placeholder="编号"/>
	        </div>
    ...
    <div class="bloc">
        ...
        <div class="content">
                  ...
                  <c:forEach items="${userListAll}" var="user">
						<tr>
							...
							<input name="" type="button" title="Edit this content" class="edittable" />
								<form action="searchPemissionDelete.action" method="post" class="deletetable">
									<input type="hidden"  name="searchPemissionDelete0" value="${user.username}" >
									<input type="hidden"  name="searchPemissionDelete1" value="${user.permission}" >
            ...
            <div class="left input">
				...
				<a href="settingroot.action?pageNo=${page.pageNo-1 }">上一页</a>&nbsp;&nbsp;&nbsp;<a href="settingroot.action?pageNo=${page.pageNo+1 }">下一页</a>
			</div>
        </div>   
    </div>
    </div>
