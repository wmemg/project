...
<body>
    ...
    <div id="sidebar">
            <ul>
                ...
                <li class="current"><a href="#"><img src="img/icons/menu/settings.png" alt="" />部门设置</a>
                    <ul>
                        <li class="current"><a href="settingdepartment.action">部门设置</a></li>
    ...
    <div id="content" class="white">
        ...
        <h1 style="width: 200px;float:left;"><img src="img/icons/posts.png" alt="" /> 部门设置</h1>
        <div class="work">
    ...
    <div class="content">
        <form enctype="multipart/form-data" action="ashx/login.ashx" method="post">
            <table class="inputfile">
                <tr>
                    <td class="inputlabel"><label>部门名称：</label></td>
                    <td class="input-input"><input type="text" /></td>
                    <td class="inputlabel"><label>部门编号：</label></td>
