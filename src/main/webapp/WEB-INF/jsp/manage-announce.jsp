...
<body>
    ...
    <div id="content" class="white">
        <div style="width: 1000px height: 67px;">
            <h1 style="width: 200px;float:left;"><img src="img/icons/posts.png" alt="" /> 公告管理</h1>
            <div class="work">
            ...
            <div action="#" class="workbutton">
                <a href="addAnnounce.action"><img src="img/icons/add.png" alt="" /></a>
            </div>
            <div action="#" class="workbutton">
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><a href="#">关于2016年上半年CET及小语种考试报名的通知</a></td>
