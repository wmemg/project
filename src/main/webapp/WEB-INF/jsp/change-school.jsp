...
<link rel="stylesheet" href="content/settings/style.css" />
  ...
  <div class="settings" id="settings">
            ...
            <ul>
                ...
                <li class="current"><a href="#"><img src="img/icons/menu/inbox.png" alt="" />异动管理</a>
                    <ul>
                        ...
                        <li class="current"><a href="changeschool.action">学生转学</a></li>
        ...
        <div id="content" class="white">
            ...
            <div class="bloc">
                <div class="title">学生转学</div>
                <div class="content">
                    <form action="changeSchool.action" method="post">
                        <table class="inputfile">
                            ...
                            <tr>
                                ...
                                <td class="inputlabel"><label>转校学校：</label></td>
                                <td><input type="text" value="不清楚" disabled="disabled" /></td>
                            </tr>
                            <tr>
        ...
        <div class="content">
            <table>
                ...
                <tbody>
                   <c:forEach items="${changeSchoolListAll}"
							var="changeSchoolListAll">
							<tr>
								<td><input type="checkbox" /></td>
								<td>${changeSchoolListAll.stuName}</td>
								<td>${changeSchoolListAll.stuId}</td>
								<td>${changeSchoolListAll.stuClassid}</td>
								<td>就不告诉你</td>
								<td><fmt:formatDate
										value="${changeSchoolListAll.date}"
										pattern="yyyy-MM-dd HH:mm:ss" /></td>
								<td>管理员</td>
								
								<td class="actions">
								<input name="" type="button" title="Edit this content" class="edittable" />
								<form action="changeSchoolDelete.action" method="post" class="deletetable">
									<!-- <a href="#" title="Delete this content"><img src="img/icons/actions/delete.png" alt="" /></a> -->
									<input type="hidden"  name="changeSchoolDelete" value="${changeSchoolListAll.stuId}" >
            ...
            <div id="pageDiv" class="pagination">
					<a href="changeschool.action?pageNo=${page.pageNo-1 }">上一页</a>&nbsp;&nbsp;&nbsp;<a
						href="changeschool.action?pageNo=${page.pageNo+1 }">下一页</a>
				</div>
        </div>   
    </div>
        </div>
