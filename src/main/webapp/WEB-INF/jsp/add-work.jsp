...
<link rel="stylesheet" href="content/settings/style.css" />
  ...
  <div class="settings" id="settings">
        ...
        <div id="content" class="white">
            <h1><img src="img/icons/posts.png" alt="" />工作交办</h1>

<div class="bloc">
    <div class="title">批量录入工作</div>
    <div class="content">
        <div class="input">
...
<div class="bloc">
    <div class="title">新增工作</div>
    <div class="content">
        <form enctype="multipart/form-data" action="ashx/login.ashx" method="post">
            <table class="inputfile">
                <tr>
                    <td class="inputlabel"><label>文    号：</label></td>
                    <td class="input-input"><input type="text" /></td>
                    <td class="inputlabel"><label>步    骤：</label></td>
                    <td><input type="text" /></td>
                </tr>
                <tr>
                    <td class="inputlabel"><label>起始时间：</label></td>
                    <td><input type="text" /></td>
                    <td class="inputlabel"><label>完成时间：</label></td>
                    <td><input type="text" /></td>
                </tr>
                <tr>
                    <td class="inputlabel"><label>状    态：</label></td>
                    <td>
                        <select>
                        <option value="1">起始</option>
                        <option value="2">进行中</option>
                        <option value="3">已完成</option>
                        <option value="3">交办中</option>
                        </select>
                    </td>
                ...
                <tr>
                    <td class="inputlabel"><label>工作说明：</label></td>
                    <td><input type="text" /></td>
                    <td class="inputlabel"><label>成    员：</label></td>
                    <td><input type="text" /></td>
                </tr>
            </table>
        </form>
