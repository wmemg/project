...
<body>
    ...
    <div id="sidebar">
            <ul>
                ...
                <c:if test="${user.permission eq 2}">
                <li class="current"><a href="#"><img src="img/icons/menu/settings.png" alt="" />系统权限管理</a>
                    <ul>
                        <li><a href="settingroot.action">权限管理</a></li>
                        <li class="current"><a href="settinguser.action">用户管理</a></li>
                    </ul>
                </li>
                </c:if>
            </ul>
    ...
    <div id="content" class="white">
        ...
        <h1 style="width: 280px;float:left;"><img src="img/icons/posts.png" alt="" /> 系统权限管理</h1>
        <div class="work">
        ...
        <div class="bloc">
    <div class="title">批量录入用户</div>
    <div class="content">
        <form action="addUserByFile.action" method="post" enctype="multipart/form-data">
        <div class="input">
        ...
        <form action="addUser.action" method="post">
            <table class="inputfile">
                <tr>
                    ...
                    <td class="inputlabel"><label>编    号：</label></td>
                    <td><input type="text" /></td>
                </tr>
                <tr>
                    <td class="inputlabel"><label>类    型：</label></td>
                    <td><input type="text" /></td>
                    <td class="inputlabel"><label>初始密码：</label></td>
                    <td><input type="text" /></td>
                </tr>
                <tr>
                    <td class="inputlabel"><label>权    限：</label></td>
                    <td><input type="text" /></td>
                    <td class="inputlabel"><label>授权时间：</label></td>
                    <td><input type="text" /></td>
                </tr>
            </table>
        </form>
    ...
    <div class="bloc">
        ...
        <div class="content">
                	...
                	<c:forEach items="${userListAll}" var="user">
						<tr>
							...
							<input name="" type="button" title="Edit this content" class="edittable" />
								<form action="settingUserDelete.action" method="post" class="deletetable">
									<input type="hidden"  name="searchUserDelete0" value="${user.username}" >
									<input type="hidden"  name="searchUserDelete1" value="${user.permission}" >
            ...
            <div class="left input">
				...
				<a href="settinguser.action?pageNo=${page.pageNo-1 }">上一页</a>&nbsp;&nbsp;&nbsp;<a href="settinguser.action?pageNo=${page.pageNo+1 }">下一页</a>
			</div>
        </div>   
    </div>
    </div>
