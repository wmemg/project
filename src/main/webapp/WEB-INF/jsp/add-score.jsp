...
<link rel="stylesheet" href="content/settings/style.css" />
  ...
  <div class="settings" id="settings">
            ...
            <ul>
                ...
                <li class="current"><a href="#"><img src="img/icons/menu/chart.png" alt="" /> 成绩管理</a>
                    <ul>
                        ...
                        <c:if test="${user.permission ne 0}"><li class="current"><a href="addscore.action">成绩录入</a></li></c:if>
        ...
        <div id="content" class="white">
            <h1><img src="img/icons/paper.png" alt="" /> 成绩管理</h1>

<div class="bloc">
    <div class="title">批量录入</div>
    <div class="content">
    
    <form action="addScoreByFile.action" method="post" enctype="multipart/form-data">
        <div class="input">
        ...
        <div class="submit">
            ...
            <input type="submit" value="导入并保留" class="black"/>
            <input type="submit" value="导入并删除" class="white"/>
        </div>
        ...
        <form action="addScore.action" method="post">
            <table class="inputfile">
                ...
                <tr>
                    ...
                    <td class="inputlabel"><label>课 程 号：</label></td>
                    <td><input type="text" name="courseId"/></td>
                </tr>
                <tr>
                    <td class="inputlabel"><label>成    绩：</label></td>
