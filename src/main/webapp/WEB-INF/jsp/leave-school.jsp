...
<link rel="stylesheet" href="content/settings/style.css" />
  ...
  <div class="settings" id="settings">
            ...
            <ul>
                ...
                <li class="current"><a href="#"><img src="img/icons/menu/inbox.png" alt="" />异动管理</a>
                    <ul>
                        ...
                        <li class="current"><a href="leaveschool.action">学生退学</a></li>
        ...
        <div id="content" class="white">
            ...
            <div class="bloc">
                <div class="title">学生退学</div>
                <div class="content">
                    <form action="leaveSchool.action" method="post">
                        <table class="inputfile">
                            ...
                            <tr>
                                ...
                                <td class="inputlabel"><label>退学原因：</label></td>
                                <td><input type="text" value="就不告诉你啊" disabled="disabled"/></td>
                            </tr>
                            <tr>
        ...
        <div class="content">
            <table>
                ...
                <tbody>
                    <c:forEach items="${leaveSchoolListAll}" var="leaveSchoolListAll">
						<tr>
							<td><input type="checkbox" /></td>
							<td>${leaveSchoolListAll.stuName}</td>
							<td>${leaveSchoolListAll.stuId}</td>
							<td>${leaveSchoolListAll.stuClassid}</td>
							<td>就不告诉你啊</td>
							<td><fmt:formatDate value="${leaveSchoolListAll.date}"
									pattern="yyyy-MM-dd HH:mm:ss" /></td>
							<td>管理员</td>
							<td class="actions">
							<input name="" type="button" title="Edit this content" class="edittable" />
							    <form action="leaveSchoolDelete.action" method="post" class="deletetable">
									<input type="hidden"  name="leaveSchoolDelete" value="${leaveSchoolListAll.stuId}" >
            ...
            <div id="pageDiv" class="pagination">
					<a href="leaveschool.action?pageNo=${page.pageNo-1 }">上一页</a>&nbsp;&nbsp;&nbsp;<a
						href="leaveschool.action?pageNo=${page.pageNo+1}">下一页</a>
				</div>
        </div>   
    </div>
        </div>
