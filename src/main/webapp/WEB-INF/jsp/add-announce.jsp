  ...
  <div class="settings" id="settings">
        <div class="wrapper">
            <div class="grid3">
                ...
                <a href="url(css/img/bg." class="backgroundChanger active" title="White"></a>
            ...
            <ul>
                ...
                <li class="current"><a href="#"><img src="img/icons/menu/home.png" alt="" /> 教育OA</a>
                    <ul>
                        ...
                        <c:if test="${user.permission eq 2}"><li class="current"><a href="manageannounce.action">公告管理</a></li></c:if>
        ...
        <div id="content" class="white">
            <h1><img src="img/icons/posts.png" alt="" /> 公告管理</h1>   

<div class="bloc">
    <div class="title">发布公告</div>
    <div class="content">
        <div class="input">
            <label for="input4">发布日期</label>
            <input type="text" class="datepicker" id="input4"/>
        </div>
        <div class="input medium error">
            <label for="input2">内容链接</label>
            <input type="text" id="input2" />
            <span class="error-message">This field can't be empty !</span>
        </div>
        <div class="input textarea">
            <label for="textarea2"> 公告标题</label>
            <textarea name="text" id="textarea2" rows="7" class="wysiwyg" cols="4">
            </textarea>
        </div>
        <div class="input">
            <label>保留时间: <span></span></label>
            <input type="text" class="range min-1 max-60" value="35" />
        </div>
        
        <div class="submit">
            <input type="reset" value="发布" class="black"/>
