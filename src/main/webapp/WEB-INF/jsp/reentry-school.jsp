		...
		<ul>
			...
			<c:if test="${user.permission eq 2}">
				<li class="current"><a href="#"><img
						src="img/icons/menu/inbox.png" alt="" />异动管理</a>
					<ul>
						<li><a href="changeclass.action">学生调班</a></li>
						<li><a href="changeschool.action">学生转学</a></li>
						<li class="current"><a href="reentryschool.action">学生复学</a></li>
				...
				<form action="reEntrySchool.action" method="post">
					<table class="inputfile">
						...
						<tr>
							...
							<td class="inputlabel"><label>复读班级：</label></td>
					...
					<span style="color:red">${error}</span>
						<input type="reset" value="重  置" class="black"
							style="margin-right: 50px;" /> <input type="submit" value="提  交"
								class="white" />
					</div>
				</form>
			</div>
		...
		<div class="bloc">
			...
			<div class="content">
				...
				<div id="pageDiv" class="pagination">
					<a href="reentryschool.action?pageNo=${page.pageNo-1 }">上一页</a>&nbsp;&nbsp;&nbsp;<a
						href="reentryschool.action?pageNo=${page.pageNo+1}">下一页</a>
				</div>
			</div>
		</div>
	</div>
